...
KERNEL_COMPILE_FLAGS        += LD=$(ANDROID_LLD_TOOLCHAIN)
...
KERNEL_CONFIGS_EXTRA        += $(TARGET_KERNEL_SOURCE)/arch/$(TARGET_ARCH)/configs/android_cms.config
endif
...
endif #ifeq ($(TARGET_PRODUCT),ulcb)

ifeq ($(TARGET_PRODUCT),kingfisher)
ifeq ($(TARGET_BOARD_PLATFORM),r8a7795)
DTB_BLOBS := \
	$(KERNEL_DTB_BLOBS)/r8a7795-ulcb-kf-android.dtb --id=0x0b779520 \
...
ifneq ($(KERNEL_CONFIGS_EXTRA),)
	$(TARGET_KERNEL_SOURCE)/scripts/kconfig/merge_config.sh -m -O $(KERNEL_OUT_ABS) \
	$(KERNEL_CONFIG) $(KERNEL_CONFIGS_EXTRA)
endif
